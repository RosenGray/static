...
console.log("nextJsNode", "nextJsNode");
...
if (
  (loadScript(reactCdn)
    .then(() => (!nextJsNode ? loadScript(reactDomCdn) : resolvePromise()))
    .then(() => loadStyle("https://rosengray.github.io/static/style.css"))
    .then(() =>
      loadScript("https://rosengray.github.io/static/accessibilik.umd.min.cjs")
    )
    .catch((e) => {
